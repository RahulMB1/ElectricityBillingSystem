...
public class MeterInfo extends JFrame implements ActionListener{
	...
	JTextField tframe, tfaddress, tfcity, tfstate, tfemail, tfphone;
	JButton next,cancel;
	JLabel lblname,lblmeterno,lblmeter,lbladdress,lblstate ,lblemail,lblcity,lblphone, lblmeternumber;
	Choice meterLocation, metertype, postalcode;
	...
	MeterInfo() {
		...
		lblcity = new JLabel("Postal Code");
		lblcity.setBounds(100,200,100,20);
		p.add(lblcity);
		
		postalcode = new Choice();
		postalcode.add("011");
		postalcode.add("022");
		postalcode.add("033");
		postalcode.add("044");
		...
		postalcode.add("088");
		postalcode.add("099");
		postalcode.setBounds(240,200,200,20);
		p.add(postalcode);
